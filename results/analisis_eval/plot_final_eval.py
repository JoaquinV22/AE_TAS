...
def main():
    ...
    ax1.set_ylabel("Mean Hypervolume (HV_mean)")
    ax1.set_xlabel("Instance")
    ax1.set_title("Mean Hypervolume per instance and algorithm")
    ...
    ax2.set_title("Mean execution time per instance and algorithm")
